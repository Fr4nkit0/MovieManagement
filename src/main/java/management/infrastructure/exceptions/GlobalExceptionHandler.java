package management.infrastructure.exceptions;

import management.infrastructure.dto.ApiResponse;
import jakarta.servlet.http.HttpServletRequest;
import jakarta.servlet.http.HttpServletResponse;

import management.application.exceptions.DuplicateRatingException;
import management.application.exceptions.InvalidPasswordException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse> handleAllExceptions(Exception exception,
        ...
        if (exception instanceof  DuplicateRatingException duplicateRatingException)
            return this.handleDuplicateRatingException(duplicateRatingException,request,response,timeTamp);
    ...
    private ResponseEntity<ApiResponse> handleDuplicateRatingException (DuplicateRatingException duplicateRatingException,
                                                                                     HttpServletRequest request,
                                                                                     HttpServletResponse response,
                                                                                     LocalDateTime timeTamp  ){
